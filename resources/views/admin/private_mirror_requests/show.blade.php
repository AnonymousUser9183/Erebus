    ...
    <div class="admin-card">
        ...
        @if ($mirrorRequest->status !== 'assigned' && $mirrorRequest->status !== 'denied')
            <div style="border-top: 1px solid var(--color-border); padding-top: var(--spacing-xl); margin-top: var(--spacing-xl);">
                ...
                <form method="POST" action="{{ route('admin.private-mirror-requests.assign', $mirrorRequest->id) }}" novalidate>
                    @csrf
                ...
                <form method="POST" action="{{ route('admin.private-mirror-requests.deny', $mirrorRequest->id) }}" style="display: inline; margin-top: var(--spacing-md);">
                    @csrf
